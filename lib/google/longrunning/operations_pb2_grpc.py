...
class OperationsServicer(object):
    ...
    def ListOperations(self, request, context):
        ...
        to use different resource name schemes, such as `user/*/operations`. To
        override the binding, API services can add a binding such as
        `"/v1/{name=user/*}/operations"` to their service configuration.
        For backwards compatibility, the default name includes the operations
        collection id, however overriding user must ensure the name binding
