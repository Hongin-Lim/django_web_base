...
class SamlChallenge(ReauthChallenge):
    """Challenge that asks the user to browse to their ID Providers.

    Currently SAML challenge is not supported. When obtaining the challenge
    input, exception will be raised to instruct the user to run
    ...
    def obtain_challenge_input(self, metadata):
        ...
        # for programmatic SAML user today. So we error our here and request
        # user to use gcloud to complete a login.
