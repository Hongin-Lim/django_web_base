...
user. In contrast to other OAuth 2.0 profiles, no user are involved and your
...
`domain-wide delegation`_ authority to access user data on behalf of user in
the domain.
...
the calendars of all user in a Google Apps domain would use a service account
to access the Google Calendar API on behalf of user.
