...
class Policy(collections.abc.MutableMapping):
    ...
    @staticmethod
    def all_users():
        """Factory method for a member representing all user.

        Returns:
            str: A member string representing all user.
        """
        return "allUsers"

    @staticmethod
    def authenticated_users():
        """Factory method for a member representing all authenticated user.

        Returns:
            str: A member string representing all authenticated user.
        """
